...
@st.cache
def load_model_ocr():
    return ocr.Reader(['ar','en'], model_storage_directory=r"E:\Downloads\car plates-\Automatic-number-plate-recognition-in-real-time-")
...
model_path_yolo = Path(r"E:\Downloads\car plates-\Automatic-number-plate-recognition-in-real-time-\best.pt")
